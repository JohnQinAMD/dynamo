...
1. Use `rocm/vllm` Docker image for vLLM ROCm integration testing
2. Install Dynamo pip package in container for gpu_utils/VMM tests
3. Multi-node RIXL UCX RDMA testing between chi2899 and chi2900
4. KVBM end-to-end test with HIP kernels on MI355X
